...
public class CaseWorkerDAOImpl implements CaseWorkerDAO {
    ...
    public List<FcChildTemp> getfoundchildrenreportlist(String foundhomeId){
     ...
     List<FcChildTemp> childList=new ArrayList<FcChildTemp>();

        try {
            childList=hibernateTemplate.findByNamedQueryAndNamedParam("FcChildTemp.findByProfileId","profileId",foundhomeId);
    ...
    //Added for getting child list by multiple types of stauts for Superintendent
     public List<ChildMaster> fetchChildrenInAHome_status(String homeId) {
        ...
        try {
            childList_status=hibernateTemplate.findByNamedQueryAndNamedParam("ChildMaster.findByHomeId_multiplestatus", "homeId", new HomeMaster(homeId));
    ...
    public List<ChildMaster> fetchTransferedChildList(String homeId) {
        ...
        try {
         ...
         transferedchildList=hibernateTemplate.findByNamedQueryAndNamedParam("ChildMaster.findByTransferStatus", "homeId", homeId);
    ...
    public List<InterviewRegister> getChildInterviewDetails(String chprofid) {
         List<InterviewRegister> list_interviewReg = null;
        try {
