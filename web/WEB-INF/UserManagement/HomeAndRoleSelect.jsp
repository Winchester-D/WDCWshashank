     ...
     <center>
          ...
          <s:form action="Select-Language-Action" name="lanSelect" theme="css_xhtml">
           <select id="sel_lan2" onchange="selLang2(this);" name="">
              ...
              <hr/>
              <p style="text-align: center">&nbsp;&nbsp;&nbsp;<a href="javascript:;" id="hover_img2" onmouseover="this.style.color='green';" onmouseout="this.style.color='#5b88aa';" onclick="switchContent('')"><b>Form7</b>:&nbsp;(Child in Conflict with Law/ Child in Need of Care and Protection)</a><br/>
        <hr/></p>
     
              <p style="text-align: center">&nbsp;&nbsp;&nbsp;<a href="javascript:;" id="hover_img2" onmouseover="this.style.color='green';" onmouseout="this.style.color='#5b88aa';" onclick="switchContent('')"><b>Form14</b>:&nbsp;(REHABILITATION CARD)</a><br/>
        <hr/></p>
     
          <p style="text-align: center">&nbsp;&nbsp;&nbsp;<a href="javascript:;" id="hover_img2" onmouseover="this.style.color='green';" onmouseout="this.style.color='#5b88aa';" onclick="switchContent('')"><b>Form43</b>:&nbsp;(CASE HISTORY OF THE CHILD)</a><br/>
        <hr/></p>
