...
<html>
 ...
 $(document).ready(function() {
     var cur =1;
    $('#dialog11').on("click", function() {
        $('<div>').dialog({
            modal: true,
            open: function ()
            {
                $(this).load('CWC_Meetings11Formde');
                $(this).load('CWC_Meetings11Formde').css('background-color','#ccffff');
            ...
            buttons: {
              ...
              1  : function()
                ...
                {
                cur++;
                $(this).load('CWC_Meetings11_2Formde');
                }
            },  
            height: 800,
            width: 1100,
    ...
    <body>
        <s:form name="cwcHomeSelectForm" id="cwcHomeSelectForm" action="CWC_Meetings11rep" method="POST" target="_blank">
            
            <h6 style="text-align: center">FORM 11<br/>
[Rule 12(1)]<br/>
...
<tr><td colspan="2" style="text-align: center"><br/><input style="text-align: center" id="dialog11" type="button" value="<s:text name="global.button.cwcProceed"/>"/></td></tr>
</table>
</s:form>
            
            <br/>
            <div style="text-align: center">
                <a href="images_Forms/Form11.pdf" target="_blank">Click for Template</a>
            </div>    
