...
<html>
    ...
    <body>
        <br/>
        <form action="form24desave" method="post" name="f">   
            <center>
                <h4>FORM 24<br/>
                    [Rule 19(22)]<br/>
            ...
            <span>(named)<input type="text" id="cpCname" name="cpCname" size="13" class="form24"/>Aged<input type="text" id="cpCage" name="cpCage" size="5" class="form24"/>having date of birth<input type="text" id="cpCbirth" name="cpCbirth" size="13" class="form24"/>for the reason:<input type="text" id="cpReason" name="cpReason" size="16" class="form24"/><br/>      
                ...
                <span style="word-spacing: 8px">(iii)&emsp;&emsp;&#8239;I/we have been counselled and informed about the implication that I/we can withdraw our consent</span><br/>
                ...
                <span style="margin-left:70%" class="form">[Signature or Thumb Impression of</span><br/>
                <span style="margin-left:78%" class="form">surrendering person(s)]</span><br/>
                ...
                <span class="form" style="margin-left:80%"><b>Signature & Seal of</b></span><br/>
                <span style="margin-left: 78%" class="form"><b>Members/Chairperson</b></span><br/>
                <span style="margin-left: 76%" class="form"><b>Child Welfare Committee</b></span> <br/>                               
