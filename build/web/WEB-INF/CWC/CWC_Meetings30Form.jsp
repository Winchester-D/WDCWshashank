 ...
 $(document).ready(function() {
    ...
    $('#dialog30').on("click", function() {
        $('<div>').dialog({
            ...
            open: function ()
            {
                $(this).load('CWC_Meetings30Formde');
                $(this).load('CWC_Meetings30Formde').css('background-color','#ccffff');
             ...
             buttons: {
                ...
                {
                cur++;
                $(this).load('CWC_Meetings30_2Formde');
                },   
                3: function()
                {
                cur--;
                $(this).load('CWC_Meetings30_3Formde');
                },
                4: function()
                {
                cur++;
                $(this).load('CWC_Meetings30_4Formde');
                },
                5: function()
                {
                cur--;
                $(this).load('CWC_Meetings30_5Formde');
                }
